...
ProvenancePE.BULK_SIZE=3
ProvenancePE.REPOS_URL='http://127.0.0.1:8082/workflowexecutions/insert'
#ProvenancePE.PROV_PATH=os.environ['PROV_PATH']
#injectProv(graph, (SeismoPE,), save_mode=ProvenancePE.SAVE_MODE_SERVICE ,controlParameters={'username':os.environ['USER_NAME'],'runId':"MISFIT_VERCE_orfeus-as-13470-87288b70-b680-11e7-af06-f45c89acf865"})
...
componentsType = {'MatchComponents':{'s-prov:type':(SeismoPE,ASTGrouped,)}}
                    
rid='MISFIT_VERCE_'+getUniqueId()
configure_prov_run(graph,None,provImpClass=(SeismoPE,),componentsType=componentsType,save_mode='file',input=[{'test':'1','blah':'3'}],username="aspinuso",workflowId="173",description="test",system_id="xxxx",workflowName="misfit",runId=rid,w3c_prov=False)
